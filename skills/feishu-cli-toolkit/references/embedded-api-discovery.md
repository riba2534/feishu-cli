...
### 第 2 步：查 `/Users/hepengcheng/airepo/feishu-open-docs`
...
```bash
# 按用途关键词找 shortcut
grep -rln "<关键词>" /Users/hepengcheng/airepo/cli/shortcuts/ --include="*.go"

# 按 API 路径片段找
grep -rn "apiPath\|/open-apis/<部分路径>" /Users/hepengcheng/airepo/cli/shortcuts/ --include="*.go"

# 找所有 docs_ai / slides_ai 等"埋藏域"
grep -rn "/docs_ai/\|/slides_ai/\|/base_ai/" /Users/hepengcheng/airepo/cli/ --include="*.go"
```
